...
def home():
    ...
    return render_template('index.html', concerts = concertsList, numConcerts = NUM_CONCERTS)
...
def chosenSeats():
    ...
    if request.method == 'POST':
        ...
        if not chosenSeats:
            flash('Must choose a seat!','error')
...
def bookseats():
    ...
    return render_template('bookseats.html', musician = concert.getMusician(), date = concert.getDate(), chosenSeats = chosenSeats, name = user.getFirstName())
